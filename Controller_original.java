...
public class Controller implements Initializable {
  ...
  @FXML private TextField creditsInput0;
  @FXML private Text text00;
  @FXML private ComboBox<String> gradeInput0;
  @FXML private Button removeButton0;
  @FXML private Text text1;
  @FXML private TextField creditsInput1;
  @FXML private Text text11;
  @FXML private ComboBox<String> gradeInput1;
  @FXML private Button removeButton1;
  @FXML private Text text2;
  @FXML private TextField creditsInput2;
  @FXML private Text text22;
  @FXML private ComboBox<String> gradeInput2;
  @FXML private Button removeButton2;
  @FXML private Text gpaOutput;
  @FXML private Text cumGPAOutput;
  @FXML private Button calcButton;
  @FXML private Button addButton;
  @FXML private Button saveButton;
  @FXML private Button newButton;
  @FXML private AreaChart<String, Double> graph;
  ...
  private void calculateGPA(ActionEvent e) {
    ...
    for (; i < model.getNumOfRows(); i++) {
      if (listOfCredits.get(i).getText().equals("") | listOfGrades.get(i).getValue() == null) {
        ...
        alert.setHeaderText(msg);
        msg =
            "Please make sure you have completely filled out the form before calculating your GPA.";
        alert.setContentText(msg);
        alert.showAndWait();
        return;
      }
  ...
  private void addRow(ActionEvent e) {
    ...
    gradeInput
        .getItems()
        .addAll("A+", "A", "A-", "B+", "B", "B-", "C+", "C", "C-", "D+", "D", "D-", "F");
